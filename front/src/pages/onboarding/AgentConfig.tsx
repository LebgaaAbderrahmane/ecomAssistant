    ...
    <div className="mx-auto max-w-2xl px-8 py-12">
      ...
      <Card className="mt-8 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <Input label="1er suivi (heures)" type="number" value={delay1} onChange={(e) => setDelay1(e.target.value)} min={1} />
          <Input label="2e suivi (heures)" type="number" value={delay2} onChange={(e) => setDelay2(e.target.value)} min={1} />
          <Input label="3e suivi (heures)" type="number" value={delay3} onChange={(e) => setDelay3(e.target.value)} min={1} />
        </div>
      </Card>
