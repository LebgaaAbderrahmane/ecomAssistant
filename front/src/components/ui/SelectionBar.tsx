...
export function SelectionBar({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-slide-up">
      <div className="flex items-center gap-2 rounded-full border border-gray-200 bg-white px-2 py-1.5 shadow-lg">
        <span className="pl-3 text-sm font-semibold text-gray-900 whitespace-nowrap">
